...
this["Handlebars"]["templates"]["openTextInput"] = Handlebars.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"component__inner opentextinput__inner\">\n"
    + ((stack1 = container.invokePartial(lookupProperty(partials,"component"),depth0,{"name":"component","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + "  <div class=\"component__widget opentextinput__widget\">\n    <div class=\"opentextinput__count-characters\">\n      <div class=\"opentextinput__count-characters-container\"><span\n          id=\"input-info\" class=\"opentextinput__count-amount\"></span></div>\n    </div>\n\n    <div class=\"opentextinput__answer-container\">\n      <textarea class=\"opentextinput__item-textbox\" placeholder=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"placeholder") || (depth0 != null ? lookupProperty(depth0,"placeholder") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"placeholder","hash":{},"data":data,"loc":{"start":{"line":11,"column":65},"end":{"line":11,"column":80}}}) : helper)))
    + "\" maxlength=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"_allowedCharacters") || (depth0 != null ? lookupProperty(depth0,"_allowedCharacters") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_allowedCharacters","hash":{},"data":data,"loc":{"start":{"line":11,"column":93},"end":{"line":11,"column":115}}}) : helper)))
    + "\" aria-describedby=\"input-info\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"userAnswerString") || (depth0 != null ? lookupProperty(depth0,"userAnswerString") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"userAnswerString","hash":{},"data":data,"loc":{"start":{"line":11,"column":147},"end":{"line":11,"column":167}}}) : helper)))
    + "</textarea>\n    </div>\n    <div class=\"opentextinput__item-modelanswer opentextinput__item-textbox\">"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"modelAnswer") || (depth0 != null ? lookupProperty(depth0,"modelAnswer") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"modelAnswer","hash":{},"data":data,"loc":{"start":{"line":13,"column":77},"end":{"line":13,"column":94}}}) : helper))) != null ? stack1 : "")
...
this["Handlebars"]["templates"]["visua11yButton"] = Handlebars.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
        }
  ...
  return "<span class=\"tooltip\">\n  "
    + container.escapeExpression(container.lambda(((stack1 = ((stack1 = ((stack1 = (depth0 != null ? lookupProperty(depth0,"_globals") : depth0)) != null ? lookupProperty(stack1,"_accessibility") : stack1)) != null ? lookupProperty(stack1,"_ariaLabels") : stack1)) != null ? lookupProperty(stack1,"visua11y") : stack1), depth0))
    + "\n</span>\n<div class=\"icon\"></div>\n"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"name") || (depth0 != null ? lookupProperty(depth0,"name") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"name","hash":{},"data":data,"loc":{"start":{"line":5,"column":0},"end":{"line":5,"column":10}}}) : helper))) != null ? stack1 : "")
    + "\n";
},"useData":true});
